...
// downward.Add a small number eps(slightly below single - precision
				   // machine precision)
//	many times	to	1. It makes a big difference
	//              (in single precision)
//	whether you
//	do
//				1 +		eps +	eps +...or
...
#include <iomanip>
		using namespace std;
	//we need this when.h is omitted

		// **********************begin main ******************************

	int		main       () {
		int		num_eps = 100000000;
		              //number of times to add eps to 1
		float		eps_sp = 5.e-8;
		              //single precision small increment
		double		eps_dp = 5.e-8;
		              //double precision small increment

		float		sum_first_sp = 1.;
		              //adding 1 first(single precision)
		float		sum_last_sp = 0.;
		              //adding 1 at the end(single precision)
		double		sum_first_dp = 1.;
		              //adding 1 first(double precision)
		double		sum_last_dp = 0.;
		              //adding 1 at the end(double precision)
