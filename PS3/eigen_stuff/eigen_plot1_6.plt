...
# titles and labels
set title 'extrapolated wavefunction b= 1.6'
set xlabel 'r'
set ylabel 'u(r)'
...
plot "eigen_basis1_b_1_6.dat" using ($1):($2) title 'est wavefunction,dim = 1', \
   "eigen_basis5_b_1_6.dat" using ($1):($2) title 'est wavefunction,dim = 5', \
   "eigen_basis10_b_1_6.dat" using ($1):($2) title 'est wavefunction,dim = 10', \
   2*x*exp(-x) title 'exact wavefunction'
  # "eigen_basis20_b_1_6.dat" using ($1):($2) title 'est wavefunction,dim = 20',\


set term png
set output "eigen_dim1_6.png"
